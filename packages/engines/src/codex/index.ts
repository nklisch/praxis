// TODO(phase-2): implemented by Unit 9 in a follow-up agent.
...
export class CodexEngine implements Engine {
  ...
  // biome-ignore lint/complexity/noUselessConstructor: placeholder — Unit 9 will add initialization
  constructor(_opts: CodexEngineOptions) {}
  ...
  async health(): Promise<HealthStatus> {
    return {
      ok: true,
      capabilities: { vision: true, streaming: true, nativeMCP: false, contextWindow: 128000 },
    };
  }
}
