...
const fakeConcepts = [
	{ id: "c1", graphId: "g.c1", name: "Variables", description: "named placeholders", aliases: [], standardsTags: [] },
	{ id: "c2", graphId: "g.c2", name: "Constants", description: "fixed values", aliases: ["literal"], standardsTags: [] },
];
